def print_stat(special_num):
    '''
    :param special_num:  the number of ZSL category
    :return: no return
    '''
    import os
    import re
    ...
    can_dir = './data/data/log/predict/candidate/'
    ref_dir = './data/data/log/predict/reference/'
    word_dict_file = './data/data/test_label_dict.json'
